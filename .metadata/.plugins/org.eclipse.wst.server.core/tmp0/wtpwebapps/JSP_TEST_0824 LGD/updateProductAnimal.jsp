...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			<h1 class="display-3">동물 상품 수정</h1>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7">
				<form name="newAnimal" action="./processUpdateProductAnimal.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
					<div class="form-group row">
						<label class="col-sm-2">동물상품 코드</label>
						<div class="col-sm-3">
							<input type="text" id="animalId" name="animalId" class="form-control" value='<%=rs.getString("p_id")%>'readonly>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-2">동물상품명</label>
						<div class="col-sm-3">
