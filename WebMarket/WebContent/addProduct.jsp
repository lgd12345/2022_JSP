	...
	<div class="container">
		...
		<form name="newProduct" action="./processAddProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
			<div class="form-group row">
				...
				<div class="col-sm-3"> <!-- 전체를3으로나눠 4등분으로나눠짐 -->
					<input type="text" id="productId"  name="productId"  class="form-control" > <!-- 부트스트렙 -->
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="unitPrice"  name="unitPrice" class="form-control" > <!--인트값인데 텍스트로 받음 -->
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="radio" name="condition" value="New " ><fmt:message key="condition_New"/>  <!--radio 개중에 하나 체크하는 거  -->
