...
public class MemberServlet extends HttpServlet {
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * MemberDAO dao = new MemberDAO(); List<MemberVO> membersList =
		 * dao.selectAllMemberList(); //List<HashMap<String, String>> membersList =
		 * dao.selectAllMemberList(); request.setAttribute("membersList", membersList);
